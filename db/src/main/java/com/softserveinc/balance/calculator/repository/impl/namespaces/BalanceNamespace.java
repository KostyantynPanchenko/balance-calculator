...
public class BalanceNamespace {
    ...
    public final static String TOTAL_UNALLOCATED_CONSUMPTION_AMOUNT = "total_unallocated_contribution_amount";
    public final static String TOTAL_UNALLOCATED_CONTRIBUTION_AMOUNT = "total_unallocated_consumption_amount";
